...
Unique immutable Flow identity: `cyf-output-scanner-resource-check-20260913-c5d63cf4`.
...
- Controller `/tmp/od11-scanner-resource-check-c5d63cf4.cjs`; exclusive state directory `/tmp/od11-scanner-resource-check-c5d63cf4`.
...
Purpose of this new read-only observation: establish fresh free RAM/disk after unrelated API50/deploy69531195 SUCCESS, before observed activation. It is not a scanner restart or repeat activation. Source c5d63cf4 and Flow021430e0 are unchanged independently reviewed read-only code. The next activation requires memory>=1526726656 and disk>=2684354560; failing observation cannot authorize activation.
