...
| Scanner unavailable cannot mark upload READY; durable verification retry and resource bounds | OD02 writer/reviewer, before OD02 accepted or any file publication enabled | OD02 upload/storage implementation in progress; application negative test pending |
...
| Local published snapshot/record cleanup with replay-safe retention | OD06 sole client writer + release guard | Missing in OD04 candidate; explicit R1 gate, see ../OD06/client-retention-gate.md |
