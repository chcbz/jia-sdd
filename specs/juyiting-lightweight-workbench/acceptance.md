...
当前 Web 候选为 `4feaa7d283b0c6bd0ab35ed6bec7fa748ace75f4`；本表授权真实服务只读证据来自其前序提交 `fe43ebc5bece2fd2e6e78e765cd523d9fb6001a5`，现提交仅改变“全部入口”CSS/测试，已单独做空 API 展开态复测，**尚未**在真实服务上重跑当前 SHA。两批证据不可混称同一次验收。
