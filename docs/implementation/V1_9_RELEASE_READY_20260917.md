...
## 后续发布校正：使用1.9.1，不部署原1.9.0

用户授权发布后，按实际线上release-record而非仅bugfix分支重新核对，发现后来上线的4744acd4/a105dd6d尚未纳入本页原候选。已补齐并验证为API14f3ec86，Web41ca32b不变，冻结release/1.9.1；原1.9.0分支与本页历史验证证据不改写。具体执行/回归见 `V1_9_1_RELEASE_FOLLOWUP_20260918.md`。
